...
public class GameUtils {
    ...
    public static final String INTENT_KEY_GAME_TYPE = "gametype";
    ...
    public static void launchGame( Activity activity, long rowid,
                                   boolean invited, int gameType )
    {
        Intent intent = new Intent( activity, BoardActivity.class );
        intent.putExtra( INTENT_KEY_ROWID, rowid );
        intent.putExtra( INTENT_KEY_GAME_TYPE, gameType );
        if ( invited ) {
    ...
    public static void launchGame( Activity activity, long rowid)
    {
        launchGame( activity, rowid, false, -1 );
    }
