...
typedef struct DrawCtxVTable {
    ...
    void DRAW_VTABLE_NAME(score_pendingScore) ( DrawCtx* dctx, 
                                                ...
                                                XP_U16 playerNum,
                                                CellFlags flags );
    void DRAW_VTABLE_NAME(updateTrayButtons) ( DrawCtx* dctx,
    											const XP_Rect* rect1,
    											const XP_Rect* rect2,
                                                XP_U16 numInTrays );
...
#define draw_updateTrayButtons(dc, r1, r2, n ) \
    CALL_DRAW_NAME3(updateTrayButtons,(dc), (r1), (r2), (n))
