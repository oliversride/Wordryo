...
Java_com_oliversride_wordryo_jni_XwJNI_gi_1to_1stream
...
Java_com_oliversride_wordryo_jni_XwJNI_gi_1from_1stream
...
JNIEXPORT void JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_comms_1getInitialAddr
...
Java_com_oliversride_wordryo_jni_XwJNI_comms_1getUUID
( JNIEnv* env, jclass C )
{
    jstring jstr = NULL;
...
Java_com_oliversride_wordryo_jni_XwJNI_dict_1getInfo
...
JNIEXPORT jboolean JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_dict_1tilesAreSame
...
Java_com_oliversride_wordryo_jni_XwJNI_dict_1getChars
...
Java_com_oliversride_wordryo_jni_XwJNI_dict_1getTileValue
...
JNIEXPORT jint JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_initJNI
( JNIEnv* env, jclass C )
{
    struct timeval tv;
...
JNIEXPORT void JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_game_1makeNewGame
...
JNIEXPORT void JNICALL Java_com_oliversride_wordryo_jni_XwJNI_game_1dispose
...
JNIEXPORT jboolean JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_game_1makeFromStream
...
JNIEXPORT jbyteArray JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_game_1saveToStream
...
JNIEXPORT void JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_game_1saveSucceeded
...
JNIEXPORT void JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_board_1invalAll
( JNIEnv *env, jclass C, jint gamePtr )
{
    XWJNI_START();
...
JNIEXPORT jboolean JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_board_1draw
( JNIEnv *env, jclass C, jint gamePtr )
{
    jboolean result;
    XWJNI_START();
...
JNIEXPORT void JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_board_1setPos
...
JNIEXPORT jboolean JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_board_1zoom
...
JNIEXPORT void JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_board_1setScoreboardLoc
...
JNIEXPORT void JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_board_1setTimerLoc
...
JNIEXPORT void JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_board_1setTrayLoc
( JNIEnv *env, jclass C, jint gamePtr, jint left, jint top,
  jint width, jint height, jint minDividerWidth, jint traySteal, jint tileInset )
{
    XWJNI_START();
    board_setTrayLoc( state->game.board, left, top, width, height,
                      minDividerWidth, traySteal, tileInset );
    XWJNI_END();
}

JNIEXPORT jboolean JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_board_1handlePenDown
...
JNIEXPORT jboolean JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_board_1juggleTray
(JNIEnv* env, jclass C, jint gamePtr )
{
    jboolean result;
    XWJNI_START();
...
JNIEXPORT jint JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_board_1getTrayVisState
(JNIEnv* env, jclass C, jint gamePtr)
{
    jboolean result;
    XWJNI_START();
...
JNIEXPORT jboolean JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_board_1hideTray
(JNIEnv* env, jclass C, jint gamePtr)
{
    jboolean result;
    XWJNI_START();
...
JNIEXPORT jboolean JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_board_1showTray
(JNIEnv* env, jclass C, jint gamePtr)
{
    jboolean result;
    XWJNI_START();
...
JNIEXPORT jboolean JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_board_1beginTrade
( JNIEnv* env, jclass C, jint gamePtr )
{
    jboolean result;
    XWJNI_START();
...
JNIEXPORT jboolean JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_board_1endTrade
( JNIEnv* env, jclass C, jint gamePtr )
{
    jboolean result;
    XWJNI_START();
...
JNIEXPORT jboolean JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_board_1toggle_1showValues
( JNIEnv* env, jclass C, jint gamePtr )
{
    jboolean result;
    XWJNI_START();
...
JNIEXPORT jboolean JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_board_1commitTurn
(JNIEnv* env, jclass C, jint gamePtr)
{
    jboolean result;
    XWJNI_START();
...
JNIEXPORT jboolean JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_board_1flip
(JNIEnv* env, jclass C, jint gamePtr)
{
    jboolean result;
    XWJNI_START();
...
JNIEXPORT jboolean JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_board_1replaceTiles
(JNIEnv* env, jclass C, jint gamePtr)
{
    jboolean result;
    XWJNI_START();
...
JNIEXPORT jboolean JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_board_1redoReplacedTiles
( JNIEnv* env, jclass C, jint gamePtr )
{
    jboolean result;
    XWJNI_START();
...
JNIEXPORT void JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_server_1reset
(JNIEnv* env, jclass C, jint gamePtr )
{
    XWJNI_START();
...
JNIEXPORT void JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_server_1handleUndo
(JNIEnv* env, jclass C, jint gamePtr)
{
    XWJNI_START();
...
JNIEXPORT jboolean JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_server_1do
(JNIEnv* env, jclass C, jint gamePtr )
{
    jboolean result;
    XWJNI_START();
...
JNIEXPORT void JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_board_1resetEngine
(JNIEnv* env, jclass C, jint gamePtr )
{
    XWJNI_START();
...
JNIEXPORT jboolean JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_board_1requestHint
...
JNIEXPORT jboolean JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_timerFired
...
JNIEXPORT jstring JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_board_1formatRemainingTiles
(JNIEnv* env, jclass C, jint gamePtr )
{
    jstring result;
    XWJNI_START_GLOBALS();
...
JNIEXPORT jstring JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_server_1formatDictCounts
...
JNIEXPORT jboolean JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_server_1getGameIsOver
( JNIEnv* env, jclass C, jint gamePtr )
{
    jboolean result;
    XWJNI_START();
...
JNIEXPORT jstring JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_model_1writeGameHistory
...
JNIEXPORT jstring JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_model_1getLastPlay
( JNIEnv* env, jclass C, jint gamePtr, jboolean gameOver )
{
    jstring result;
    XWJNI_START_GLOBALS();
    XWStreamCtxt* stream = and_empty_stream( MPPARM(mpool) globals );
    model_getLastPlay( state->game.model, stream, state->game.server,
                            gameOver );
    result = streamToJString( env, stream );
    stream_destroy( stream );
    XWJNI_END();
...
JNIEXPORT jint JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_model_1getNMoves
( JNIEnv* env, jclass C, jint gamePtr )
{
    jint result;
    XWJNI_START();
...
JNIEXPORT jstring JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_model_1getPlayersLastScore
...
JNIEXPORT jstring JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_server_1writeFinalScores
( JNIEnv* env, jclass C, jint gamePtr )
{
    jstring result;
    XWJNI_START_GLOBALS();
...
JNIEXPORT void JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_server_1initClientConnection
( JNIEnv* env, jclass C, jint gamePtr )
{
    LOG_FUNC();
    XWJNI_START_GLOBALS();
...
JNIEXPORT void JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_comms_1start
( JNIEnv* env, jclass C, jint gamePtr )
{
    XWJNI_START();
    if ( !!state->game.comms ) {
...
JNIEXPORT void JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_comms_1resetSame
( JNIEnv* env, jclass C, jint gamePtr )
{
    XWJNI_START();
    if ( !!state->game.comms ) {
...
JNIEXPORT void JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_comms_1getAddr
...
JNIEXPORT jobjectArray JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_comms_1getAddrs
( JNIEnv* env, jclass C, jint gamePtr )
{
...
JNIEXPORT void JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_comms_1setAddr
( JNIEnv* env, jclass C, jint gamePtr, jobject jaddr )
{
    XWJNI_START();
    if ( state->game.comms ) {
...
JNIEXPORT jboolean JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_game_1receiveMessage
...
JNIEXPORT void JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_game_1summarize
...
JNIEXPORT jboolean JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_board_1server_1prefsChanged
...
#ifdef KEYBOARD_NAV
JNIEXPORT jint JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_board_1getFocusOwner
( JNIEnv* env, jclass C, jint gamePtr )
{
    jint result;
    XWJNI_START();
...
JNIEXPORT jboolean JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_board_1focusChanged
...
#ifdef KEYBOARD_NAV
JNIEXPORT jboolean JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_board_1handleKey
...
JNIEXPORT void JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_game_1getGi
( JNIEnv* env, jclass C, jint gamePtr, jobject jgi )
{
    XWJNI_START_GLOBALS();
    setJGI( env, jgi, globals->gi );
...
JNIEXPORT void JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_game_1getState
( JNIEnv* env, jclass C, jint gamePtr, jobject jgsi )
{
    ...
    setBool( env, jgsi, "canUndo", info.canUndo);
...
JNIEXPORT jboolean JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_game_1hasComms
( JNIEnv* env, jclass C, jint gamePtr )
{
    jboolean result;
    XWJNI_START();
...
JNIEXPORT jboolean JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_game_1changeDict
...
JNIEXPORT void JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_comms_1resendAll
...
#ifdef XWFEATURE_COMMSACK
JNIEXPORT void JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_comms_1ackAny
( JNIEnv* env, jclass C, jint gamePtr )
{
    XWJNI_START();
    XP_ASSERT( !!state->game.comms );
...
JNIEXPORT void JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_comms_1transportFailed
( JNIEnv* env, jclass C, jint gamePtr )
{
    XWJNI_START();
    XP_ASSERT( !!state->game.comms );
...
JNIEXPORT jboolean JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_comms_1isConnected
( JNIEnv* env, jclass C, jint gamePtr )
{
    jboolean result;
    XWJNI_START();
...
JNIEXPORT void JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_server_1endGame
( JNIEnv* env, jclass C, jint gamePtr )
{
    XWJNI_START();
    XP_ASSERT( !!state->game.server );
...
JNIEXPORT void JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_server_1sendChat
...
JNIEXPORT jint JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_dict_1iter_1init
...
JNIEXPORT void JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_dict_1iter_1setMinMax
...
JNIEXPORT void JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_dict_1iter_1destroy
...
JNIEXPORT jint JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_dict_1iter_1wordCount
(JNIEnv* env, jclass C, jint closure )
{
    jint result = 0;
    DictIterData* data = (DictIterData*)closure;
...
Java_com_oliversride_wordryo_jni_XwJNI_dict_1iter_1getCounts
(JNIEnv* env, jclass C, jint closure )
{
...
JNIEXPORT jobjectArray JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_dict_1iter_1getPrefixes
( JNIEnv* env, jclass C, jint closure )
{
    jobjectArray result = NULL;
    DictIterData* data = (DictIterData*)closure;
...
JNIEXPORT jintArray JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_dict_1iter_1getIndices
( JNIEnv* env, jclass C , jint closure )
{
...
JNIEXPORT jstring JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_dict_1iter_1nthWord
...
JNIEXPORT jint JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_dict_1iter_1getStartsWith
...
JNIEXPORT jstring JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_dict_1iter_1getDesc
( JNIEnv* env, jclass C, jint closure )
{
    jstring result = NULL;
    DictIterData* data = (DictIterData*)closure;
...
JNIEXPORT jstring JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_base64Encode
...
JNIEXPORT jbyteArray JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_base64Decode
...
JNIEXPORT jstring JNICALL
Java_com_oliversride_wordryo_jni_XwJNI_stringFromJNI( JNIEnv* env,
                                                      jobject thiz )
{
#if defined(__arm__)
...
#define ABI "unknown"
    ...
    return (*env)->NewStringUTF(env, "Hello from JNI in xwjni.c !  Compiled with ABI " ABI ".");
}
