...
import com.oliversride.wordryo.MultiService.MultiEvent;
...
public class SMSService extends Service {
    ...
    BroadcastReceiver mReceiverSent = new BroadcastReceiver(){
        @Override
    ...
    BroadcastReceiver mReceverDelivered = new BroadcastReceiver(){
        @Override
        public void onReceive(Context arg0, Intent arg1) 
        {
    ...
    {
        registerReceiver(mReceiverSent, new IntentFilter(MSG_SENT) );
...
//        }, new IntentFilter(MSG_SENT) );
        ...
        registerReceiver(mReceverDelivered, new IntentFilter(MSG_DELIVERED) );
//        registerReceiver( new BroadcastReceiver() {
//            @Override
//            public void onReceive(Context arg0, Intent arg1) 
//            {
...
//        }, new IntentFilter(MSG_DELIVERED) );
    ...
    public void onDestroy() {
    	unregisterReceiver(mReceiverSent);
    	unregisterReceiver(mReceverDelivered);
    	super.onDestroy();
    }
}
