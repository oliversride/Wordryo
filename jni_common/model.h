...
#define ANDROID_MOVE_BIT 0x0400
#define HINT_MOVE_BIT 0x0002
XP_Bool gbAndroidPlaying;
XP_Bool gbHint;
#define MAX_ANDROID_TILES 7
typedef struct AndroidMove {
	XP_U16 col;
	XP_U16 row;
} AndroidMove;
AndroidMove gAndroidMove[MAX_ANDROID_TILES];
XP_U8 gNAndroidMove;
...
XP_Bool model_androidPlaying( const ModelCtxt* model, XP_U16 col, XP_U16 row);
void model_clearAndroidPlaying( );
XP_Bool model_androidMove( const ModelCtxt* model );
...
XP_Bool model_canShuffle( const ModelCtxt* model, XP_U16 turn, 
                          XP_Bool trayVisible );
XP_Bool model_canUndo( const ModelCtxt* model, XP_U16 turn );
...
void model_writeGameHistory( ModelCtxt* model, XWStreamCtxt* stream,
                             ...
                             XP_Bool gameOver );
void model_getLastPlay( ModelCtxt* model, XWStreamCtxt* stream,
                             ServerCtxt* server, /* for player names */
                             XP_Bool gameOver );
